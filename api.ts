...
export const DysonSphereProgramApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @summary Get the computed recipe
         * @param {boolean} [group] Whether or not to group the recipes in the computed recipe up by name
         * @param {1 | 2 | 3} [assemblerLevel] 
         * @param {1 | 2} [chemicalPlantLevel] 
         * @param {1 | 2} [smelterLevel] 
         * @param {Array<GetDSPComputedRecipeRequestInner>} [recipeRequest] A JSON object containing your recipe requirements
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        getDSPComputedRecipe: async (group?: boolean, assemblerLevel?: 1 | 2 | 3, chemicalPlantLevel?: 1 | 2, smelterLevel?: 1 | 2, recipeRequest?: Array<GetDSPComputedRecipeRequestInner>, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            ...
            if (assemblerLevel !== undefined) {
                localVarQueryParameter['assemblerLevel'] = assemblerLevel;
            }

            if (chemicalPlantLevel !== undefined) {
                localVarQueryParameter['chemicalPlantLevel'] = chemicalPlantLevel;
            }

            if (smelterLevel !== undefined) {
                localVarQueryParameter['smelterLevel'] = smelterLevel;
            }
...
export const DysonSphereProgramApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async getDSPComputedRecipe(group?: boolean, assemblerLevel?: 1 | 2 | 3, chemicalPlantLevel?: 1 | 2, smelterLevel?: 1 | 2, recipeRequest?: Array<GetDSPComputedRecipeRequestInner>, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<ComputedRecipe>>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getDSPComputedRecipe(group, assemblerLevel, chemicalPlantLevel, smelterLevel, recipeRequest, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * Get all DSP recipes
...
export const DysonSphereProgramApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        getDSPComputedRecipe(group?: boolean, assemblerLevel?: 1 | 2 | 3, chemicalPlantLevel?: 1 | 2, smelterLevel?: 1 | 2, recipeRequest?: Array<GetDSPComputedRecipeRequestInner>, options?: any): AxiosPromise<Array<ComputedRecipe>> {
            return localVarFp.getDSPComputedRecipe(group, assemblerLevel, chemicalPlantLevel, smelterLevel, recipeRequest, options).then((request) => request(axios, basePath));
        },
        /**
         * Get all DSP recipes
         * @summary Get all DSP recipes
...
export class DysonSphereProgramApi extends BaseAPI {
     ...
     */
    public getDSPComputedRecipe(group?: boolean, assemblerLevel?: 1 | 2 | 3, chemicalPlantLevel?: 1 | 2, smelterLevel?: 1 | 2, recipeRequest?: Array<GetDSPComputedRecipeRequestInner>, options?: AxiosRequestConfig) {
        return DysonSphereProgramApiFp(this.configuration).getDSPComputedRecipe(group, assemblerLevel, chemicalPlantLevel, smelterLevel, recipeRequest, options).then((request) => request(this.axios, this.basePath));
    }

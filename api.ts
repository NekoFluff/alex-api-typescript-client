...
export interface GetDSPComputedRecipeRequestInner {
     ...
     * @memberof GetDSPComputedRecipeRequestInner
     */
    'assemblerLevel'?: GetDSPComputedRecipeRequestInnerAssemblerLevelEnum;
    /**
     * 
...
export const GetDSPComputedRecipeRequestInnerAssemblerLevelEnum = {
    NUMBER_1: 1,
    NUMBER_2: 2,
    NUMBER_3: 3
} as const;

export type GetDSPComputedRecipeRequestInnerAssemblerLevelEnum = typeof GetDSPComputedRecipeRequestInnerAssemblerLevelEnum[keyof typeof GetDSPComputedRecipeRequestInnerAssemblerLevelEnum];

...
export const DysonSphereProgramApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        getDSPComputedRecipe: async (group?: boolean, assemblerLevel?: 1 | 2 | 3, recipeRequest?: Array<GetDSPComputedRecipeRequestInner>, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
...
export const DysonSphereProgramApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async getDSPComputedRecipe(group?: boolean, assemblerLevel?: 1 | 2 | 3, recipeRequest?: Array<GetDSPComputedRecipeRequestInner>, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<ComputedRecipe>>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getDSPComputedRecipe(group, assemblerLevel, recipeRequest, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * Get all DSP recipes
...
export const DysonSphereProgramApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        getDSPComputedRecipe(group?: boolean, assemblerLevel?: 1 | 2 | 3, recipeRequest?: Array<GetDSPComputedRecipeRequestInner>, options?: any): AxiosPromise<Array<ComputedRecipe>> {
            return localVarFp.getDSPComputedRecipe(group, assemblerLevel, recipeRequest, options).then((request) => request(axios, basePath));
        },
        /**
         * Get all DSP recipes
         * @summary Get all DSP recipes
...
export class DysonSphereProgramApi extends BaseAPI {
     ...
     */
    public getDSPComputedRecipe(group?: boolean, assemblerLevel?: 1 | 2 | 3, recipeRequest?: Array<GetDSPComputedRecipeRequestInner>, options?: AxiosRequestConfig) {
        return DysonSphereProgramApiFp(this.configuration).getDSPComputedRecipe(group, assemblerLevel, recipeRequest, options).then((request) => request(this.axios, this.basePath));
    }
